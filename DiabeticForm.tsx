...
import { DiabeticDetail } from "./types";

interface DiabeticFormProps {
  detail: DiabeticDetail;
  onChange: (detail: DiabeticDetail) => void;
  errors: Record<string, string>;
}

const DiabeticForm: React.FC<DiabeticFormProps> = ({
  detail,
  onChange,
  errors,
}) => {
  const handleChange = (field: keyof DiabeticDetail, value: any) => {
